...
from .inventory_model import Product, Inventory, Category, ProductType
from .logistics_model import Location, Supplier, Purchase, PurchaseDetail, Movement, MovementDetail
