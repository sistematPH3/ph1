"""actualizacion_tablas

Revision ID: 63d9482852fb
Revises: 
Create Date: 2026-05-22 21:58:43.360140
...
def upgrade():
    ...
    sa.Column('product_id', sa.Integer(), nullable=True),
    sa.Column('quantity', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('price_usd', sa.Numeric(precision=15, scale=2), nullable=True),
    sa.Column('exchange_rate_bcv', sa.Numeric(precision=15, scale=4), nullable=True),
